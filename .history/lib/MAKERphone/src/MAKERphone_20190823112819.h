...
#define BTN_HOME 13 // Robert button 13 - home button
#define BTN_A 16
#define BTN_B 17
#define BTN_UP 18
#define BTN_DOWN 19
...
class MAKERphone:public Buttons, public DateTime
{
  public:
	...
	uint16_t sleepTimeActual = 30; //in seconds was 0
	...
	String carrierName = "";
	uint8_t sleepTime = 30; // Robert,  was 0
	...
	uint8_t oscillatorVolumeList[15] = {0,5,9,15,20,27,37,48,56,63,73,83,92,100,120};
	String waitForOK();
