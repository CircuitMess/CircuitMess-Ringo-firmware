...
void setup()
{
	...
	if(EEPROM.readBool(33))
		startupWizard();
	// mp.pduDecode("0791839515001000040C91839535685687000891806291402080040076010D");
	// mp.pduDecode("069183950124F2040C918395121548670000919010411254800A31D98C56B3DD703918"); //069183950124F2040C91839512154867000091809271306080121BD486B7496D7C9BD706B8E96D28BD08
	// Serial.println(myDecode("31584C1E8BC160", 7));
